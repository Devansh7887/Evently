...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-purple-900 to-indigo-900 text-white mt-16">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Your premier destination for unforgettable events and experiences. Book tickets for concerts, shows, and live events.
            </p>
          </div>
          ...
          {/* Contact & Social */}
          <div>
            <h4 className="text-lg font-bold mb-4 text-yellow-300">Connect With Us</h4>
            <div className="space-y-3 text-sm">
              <p className="text-gray-300">
                <span className="font-semibold">Email:</span> info@eventapp.com
              </p>
              <p className="text-gray-300">
        ...
        <div className="mt-8 pt-6 border-t border-gray-700 text-center">
          <p className="text-gray-400 text-sm">
            Copyright &copy; {new Date().getFullYear()} EventApp. All Rights Reserved.
          </p>
